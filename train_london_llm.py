"""
Training script for London Historical LLM (1500-1850)
...
# -----------------------------------------------------------------------------
# Configuration for London Historical LLM
# -----------------------------------------------------------------------------
...
batch_size = 8
block_size = 256  # Smaller context for historical texts

# Model architecture - smaller for historical data
n_layer = 8
n_head = 8
n_embd = 512
dropout = 0.1
...
# Wandb logging
wandb_log = False
wandb_project = 'london-historical-llm'
wandb_run_name = f'london-llm-{int(time.time())}'
