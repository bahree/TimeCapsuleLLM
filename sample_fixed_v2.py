#!/usr/bin/env python3
"""
Fixed sample script that properly uses the custom tokenizer
"""
...
def load_model(checkpoint_path, device, vocab_size):
    """Load the model with proper vocabulary size"""
...
def main():
    parser = argparse.ArgumentParser(description='Generate text from London Historical LLM')
    ...
    print("🏛️  London Historical LLM Text Generation (Fixed v2)")
    print("=" * 60)
    ...
    model = load_model(checkpoint_path, device, vocab_size)
