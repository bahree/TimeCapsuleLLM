...
class LondonHistoricalEvaluator:
    def __init__(self, 
                 ...
                 output_dir: str = "05_evaluation/results"):
    ...
    def evaluate_perplexity(self, test_texts: List[str]) -> Dict[str, float]:
        ...
        for text in tqdm(test_texts, desc="Computing perplexity"):
            try:
                ...
                logger.warning(f"⚠️ Error computing perplexity for text: {e}")
                continue
        ...
        if perplexities:
            ...
            logger.error("❌ No valid perplexity scores computed")
            return {}
    ...
    def evaluate_language_quality(self, test_texts: List[str]) -> Dict[str, float]:
        ...
        if not generated_texts:
            logger.error("❌ No generated texts for quality evaluation")
            return {}
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="05_evaluation/results",
                       help="Directory to save evaluation results")
    
    args = parser.parse_args()
    
    print("📊 London Historical LLM - Model Evaluation")
    print("=" * 50)
